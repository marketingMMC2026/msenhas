...
const VaultPage = () => {
  ...
  const [modalState, setModalState] = useState({
    type: null, // 'create', 'edit', 'view', 'share', 'delete', 'import'
    data: null
  });
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      toast({ title: 'Excluido', description: 'Senha excluida com sucesso.' });
      refresh();
      closeModal();
    } catch (err) {
    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-1">Cofre de Senhas</h1>
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-700 p-4 rounded-lg flex items-center justify-between">
             <div className="flex items-center gap-2">
               ...
               <span>Falha ao carregar senhas: {error}</span>
             </div>
        ...
        <AlertDialog open={modalState.type === 'delete'} onOpenChange={closeModal}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Essa acao nao pode ser desfeita. Isso excluira permanentemente a senha
