...
const dictionaries = {
  pt: {
    ...
    deleted: 'Senha excluída', passwordDeleted: 'A senha foi removida do cofre.', deleteConfirmTitle: 'Excluir senha?', deleteConfirmBody: 'Esta ação vai remover a senha', cancel: 'Cancelar', deletePassword: 'Excluir senha', loadPasswordsError: 'Não foi possível carregar as senhas', retry: 'Tentar novamente',
  ...
  en: {
    ...
    deleted: 'Password deleted', passwordDeleted: 'The password was removed from the vault.', deleteConfirmTitle: 'Delete password?', deleteConfirmBody: 'This action will remove the password', cancel: 'Cancel', deletePassword: 'Delete password', loadPasswordsError: 'Could not load passwords', retry: 'Try again',
